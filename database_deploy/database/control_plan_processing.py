...
import backend.function.ce_file as ce
...
def pushControlPlan(worksheet, size, type):
    ...
    cursor = cnxn.cursor()
    if type == "A":
        cursor.execute("SELECT * FROM " + backend.constrain.TABLE_CONTROL_PLAN_A)
        for index in range(7, size):
            ...
            cursor.execute("""INSERT INTO """ + backend.constrain.TABLE_CONTROL_PLAN_A + """ (ITEM, CATALOG_NAME, PARA_NAME, POR_VALUE ,PRIORITY_VALUE, TAG_NAME, GU_ID) VALUES (%s, %s, %s, %s, %s, %s, %s)""", (temp0, temp1, temp2, temp3, temp4, temp5, temp6))
            cnxn.commit()
    elif type == "B":
        cursor.execute("SELECT * FROM " + backend.constrain.TABLE_CONTROL_PLAN_B)
        for index in range(7, size):
            temp0 = str(worksheet.cell(row=index, column=1).value)
            temp1 = str(worksheet.cell(row=index, column=3).value) 
            temp2 = str(worksheet.cell(row=index, column=4).value)
            ...
            if temp5 == None: temp5 = '0'
            if temp6 == None: temp6 = '0'
            cursor.execute("""INSERT INTO """ + backend.constrain.TABLE_CONTROL_PLAN_B + """ (ITEM, CATALOG_NAME, PARA_NAME, POR_VALUE ,PRIORITY_VALUE, TAG_NAME, GU_ID) VALUES (%s, %s, %s, %s, %s, %s, %s)""", (temp0, temp1, temp2, temp3, temp4, temp5, temp6))
            cnxn.commit()
    elif type == "C":
        cursor.execute("SELECT * FROM " + backend.constrain.TABLE_CONTROL_PLAN_C)
        for index in range(7, size):
            temp0 = str(worksheet.cell(row=index, column=1).value)
            temp1 = str(worksheet.cell(row=index, column=3).value) 
            temp2 = str(worksheet.cell(row=index, column=4).value)
            ...
            if temp5 == None: temp5 = '0'
            if temp6 == None: temp6 = '0'
            cursor.execute("""INSERT INTO """ + backend.constrain.TABLE_CONTROL_PLAN_C + """ (ITEM, CATALOG_NAME, PARA_NAME, POR_VALUE ,PRIORITY_VALUE, TAG_NAME, GU_ID) VALUES (%s, %s, %s, %s, %s, %s, %s)""", (temp0, temp1, temp2, temp3, temp4, temp5, temp6))
            cnxn.commit()
    cnxn.close()
